...
public class OldSearchServiceTest {
    ...
    @InjectMocks
    private OldSearchService oldSearchService;

    @BeforeEach
    public void setUp() {
        oldSearchService = new OldSearchService(itemRepository, itemJpaRepository);
    }
    ...
    void givenTextWithBrand_whenGetCataloguesByText_thenReturnsCatalogueWithNullBrand() {
        ...
        List<CatalogueElasticDto> result = oldSearchService.getCataloguesByTextByAllParameters("MockText", pageable);
    ...
    void givenTextAndCatalogueId_whenGetCataloguesByText_thenReturnsCatalogueWithMatchingId() {
        ...
        List<CatalogueElasticDto> result = oldSearchService.getCataloguesByTextByAllParameters(text, pageable);
    ...
    void givenTextAndBrandAndType_whenGetCataloguesByText_thenReturnsCatalogueWithMatchingId() {
        ...
        when(itemRepository.findAllFulltextNotStrong(eq("text"), eq(pageable))).thenReturn(mockItemList);
        when(itemRepository.findAllFulltextNotStrong(eq("Mock"), eq(pageable))).thenReturn(Collections.emptyList());
        when(itemRepository.findAllFulltextNotStrong(eq(convert("Mock")), eq(pageable))).thenReturn(Collections.emptyList());
